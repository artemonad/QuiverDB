...
pub fn exec(path: PathBuf, json: bool) -> Result<()> {
    ...
    let sum: VacuumSummary = db.vacuum_all()
    ...
    println!("  buckets_compacted    = {}", sum.compaction.buckets_compacted);
    println!("  old_chain_len_sum    = {}", sum.compaction.old_chain_len_sum);
    println!("  keys_kept_sum        = {}", sum.compaction.keys_kept_sum);
    println!("  keys_deleted_sum     = {}", sum.compaction.keys_deleted_sum);
    println!("  pages_written_sum    = {}", sum.compaction.pages_written_sum);
